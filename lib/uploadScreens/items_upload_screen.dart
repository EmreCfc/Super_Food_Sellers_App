...
class _ItemsUploadScreenState extends State<ItemsUploadScreen>
{
  ...
  takeImage(mContext)
  {
    return showDialog(
      ...
      {
        return SimpleDialog(
          title: const Text("Menu Image", style: TextStyle(color: Colors.amberAccent, fontWeight: FontWeight.bold),),
          children: [
            SimpleDialogOption(
              child: const Text(
                "Capture with Camera",
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          ListTile(
            leading: const Icon(Icons.perm_device_information,  color: Colors.redAccent,),
            title: Container(
              width: 250,
              child: TextField(
          ...
          ListTile(
            leading: const Icon(Icons.title,  color: Colors.redAccent,),
            title: Container(
              width: 250,
              child: TextField(
                style: const TextStyle(color: Colors.black),
          ...
          ListTile(
            leading: const Icon(Icons.camera,  color: Colors.redAccent,),
            title: Container(
              width: 250,
              child: TextField(
