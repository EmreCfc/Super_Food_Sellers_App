...
import 'package:superfood_app/mainScreens/earnings_screen.dart';
import 'package:superfood_app/mainScreens/history_screen.dart';
import 'package:superfood_app/mainScreens/home_screen.dart';
import 'package:superfood_app/mainScreens/new_orders_screen.dart';
          ...
          Container(
            ...
            child: Column(
              children:  [
                ...
                style: TextStyle(color: Colors.redAccent,fontSize: 20,fontFamily: "Train"),
                ),
              ],
            ),
          ),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                ListTile(
                  leading: const Icon(Icons.reorder,color: Colors.redAccent,),
                ...
                ListTile(
                  leading: const Icon(Icons.local_shipping,color: Colors.redAccent,),
